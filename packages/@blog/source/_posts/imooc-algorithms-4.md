...
author: Mitscherlich
cover: https://img-mitscherlich-me.oss-cn-hangzhou.aliyuncs.com/imooc-algorithms/image-002.jpg
...
![img](https://img-mitscherlich-me.oss-cn-hangzhou.aliyuncs.com/imooc-algorithms/image-002.jpg)
...
![img](https://img-mitscherlich-me.oss-cn-hangzhou.aliyuncs.com/imooc-algorithms/Heapify.png)
...
![img](https://img-mitscherlich-me.oss-cn-hangzhou.aliyuncs.com/imooc-algorithms/Heapify.gif)
...
![img](https://img-mitscherlich-me.oss-cn-hangzhou.aliyuncs.com/imooc-algorithms/HeapSort0.png)

> 一个已经形成最大堆的数组

我们假定通过 `Heapify` 已经使一个数组形成最大堆，这时数组中第一个元素也就是最大的元素，要是数组从小到大排序，只需使现在数组第一个位置的元素与最后一个元素交换位置：

![img](https://img-mitscherlich-me.oss-cn-hangzhou.aliyuncs.com/imooc-algorithms/HeapSort1.png)

而此时由于 `w` 并不一定是最大元素，也就使得原有最大堆的性质遭到了破坏。这时只需通过对 `w` 元素进行一次 `shiftDown` 操作，就能使数组的前部重新形成最大堆：

![img](https://img-mitscherlich-me.oss-cn-hangzhou.aliyuncs.com/imooc-algorithms/HeapSort2.png)
...
![img](https://img-mitscherlich-me.oss-cn-hangzhou.aliyuncs.com/imooc-algorithms/IndexMaxHeap.png)
...
![img](https://img-mitscherlich-me.oss-cn-hangzhou.aliyuncs.com/imooc-algorithms/RevIndexMaxHeap.png)
...
![img](https://img-mitscherlich-me.oss-cn-hangzhou.aliyuncs.com/imooc-algorithms/SortSummary.png)
...
![img](https://img-mitscherlich-me.oss-cn-hangzhou.aliyuncs.com/imooc-algorithms/SortStable.png)
